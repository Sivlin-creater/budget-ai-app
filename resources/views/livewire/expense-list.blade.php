        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-rose-100 mt-1">Manage and track your expenses</p>
                </div>
                <a href="/expenses/create" class="bg-white/20 hover:bg-white/30 text-white px-6 py-3 rounded-lg font-semibold transition flex items-center gap-2">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-6 border-t-4 border-pink-600">
            <div class="flex items-center justify-between mb-4">
                ...
                <button wire:click="$toggle('showFilters')" class="text-pink-600 hover:text-rose-700 text-sm font-medium">
            ...
            @if($showFilters)
                <div class="mt-4 flex items-center justify-between pt-4 border-t border-gray-200">
                    ...
                    <button wire:click="clearFilters" class="text-sm text-pink-600 hover:text-rose-700 font-medium">
                        Clear Filters
                    </button>
                </div>
            @endif
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead class="bg-gray-50 border-b border-rose-200">
                        <tr>
                            <th wire:click="sortBy('date')" class="px-6 py-4 text-left text-xs font-medium text-rose-500 uppercase tracking-wider cursor-pointer hover:bg-rose-100">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="/expenses/{{ $expense->id }}/edit" 
                                           class="text-pink-600 hover:text-rose-900 transition">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <a href="/expenses/create" class="bg-rose-600 hover:bg-rose-700 text-white px-6 py-2 rounded-lg font-semibold transition">
