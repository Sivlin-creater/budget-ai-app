<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form wire:submit="save" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="amount" wire:model="amount" step="0.01" min="0" placeholder="0.00"
                                class="w-full pl-8 pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('amount') border-red-500 @enderror">
                        </div>
                        @error('amount')
                    ...
                    <div>
                        ...
                        <input type="date" id="date" wire:model="date"
                            class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('date') border-red-500 @enderror">
                        @error('date')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="title" wire:model="title" placeholder="e.g., Grocery Shopping"
                            class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('title') border-red-500 @enderror">
                        @error('title')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Don't see your category? <a href="/categories"
                                class="text-pink-600 hover:text-pink-700 font-medium">Create one</a>
                        </p>
                    </div>
            ...
            <!-- Expense Type Card -->
            <div class="bg-white rounded-xl shadow-md p-6 border-t-4 border-pink-600">
                <h3 class="text-lg font-semibold text-gray-800 mb-6">Expense Type</h3>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <label
                        class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition {{ $type === 'one-time' ? 'border-pink-500 bg-purple-50' : 'border-gray-200 hover:border-gray-300' }}">
                        <input type="radio" wire:model.live="type" value="one-time" class="sr-only">
                        <div class="flex-1">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-10 h-10 rounded-lg {{ $type === 'one-time' ? 'bg-pink-600' : 'bg-gray-300' }} flex items-center justify-center">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select wire:model="recurring_frequency" id="recurring_frequency"
                                    class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('recurring_frequency') border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <input type="date" id="recurring_start_date" wire:model="recurring_start_date"
                                    class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('recurring_start_date') border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <input type="date" id="recurring_end_date" wire:model="recurring_end_date"
                                    class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('recurring_end_date') border-red-500 @enderror">
            ...
            <div class="flex items-center justify-between">
                <a href="/expenses"
                    class="px-6 py-3 bg-white/20 text-white font-semibold rounded-lg hover:bg-white/30 transition">
                    Cancel
                </a>
                <button type="submit"
                    class="px-8 py-3 bg-gradient-to-r from-pink-600 to-rose-600 text-white rounded-lg font-semibold hover:shadow-lg transition transform hover:-translate-y-0.5 flex items-center gap-2">
