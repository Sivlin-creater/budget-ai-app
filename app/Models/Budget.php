...
class Budget extends Model
{
    ...
    public function daysRemaining()
    {
        ...
        return max(now()->diffInDays($date->endOfMonth(), false), 0);
    }

    public function dailyLimit()
    {
        return $this->amount / \Carbon\Carbon::create($this->year, $this->month, 1)->daysInMonth;
    }

    public function dailyAverageSpent()
    {
        $daysPassed = max(now()->day - 1, 1);
        return $this->getSpentAmount() / $daysPassed;
    }
