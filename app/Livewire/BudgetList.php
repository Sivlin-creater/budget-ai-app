...
class BudgetList extends Component
{
    ...
    public array $expandedBudgets = [];

    public $selectedMonth;
    public $selectedYear;
    public $showCreatedModel = false;
    ...
    {
        if (in_array($budgetId, $this->expandedBudgets)) {
            $this->expandedBudgets = array_diff($this->expandedBudgets, [$budgetId]);
        } else {
            $this->expandedBudgets[] = $budgetId;
        }
    }
